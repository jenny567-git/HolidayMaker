...
export default {
    ...
    methods: {
        ...
        createBooking() {
						...
						var booking = {
								startDate: this.$store.state.searchString.dates[0].toLocaleDateString('sv-SE'),
								endDate : this.$store.state.searchString.dates[1].toLocaleDateString('sv-SE'),
							...
							if(bookingDetails.noOfDoubleRooms > 0){
								booking.reservedRooms.push({roomId: bookingDetails.doubleRoomId , bookedRooms: bookingDetails.noOfDoubleRooms});
							}
							if(bookingDetails.noOfFamilyRooms > 0){
								booking.reservedRooms.push({roomId: bookingDetails.familyRoomId , bookedRooms: bookingDetails.noOfFamilyRooms});
							}
